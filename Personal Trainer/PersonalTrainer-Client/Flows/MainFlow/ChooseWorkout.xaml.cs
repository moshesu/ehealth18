...
namespace PersonalTrainer_Client.Flows.MainFlow
{
    ...
    /// </summary>
    public sealed partial class ChooseWorkout : Page
    {
        ...
        private void workoutList_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            WorkoutParams.resetTimer = true;
            WorkoutParams.isFinishedExercise = false;
            WorkoutParams.startNewWorkout = true;
            WorkoutParams.workoutId = workoutId;
            Speak($"Have a nice workout,,, {MainDashboard.CurrentUser.Name}!");

            Frame.Navigate(typeof(WorkoutDashboard), null);
