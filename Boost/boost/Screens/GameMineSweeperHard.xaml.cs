...
namespace boost.Screens
{
	...
	/// </summary>
	public sealed partial class GameMineSweeperHard : Page
	{
		...
		static int dimensionX = 30;
		static int dimensionY = 30;

		static int parameterX = 168;
		static int parameterY = 64;

		static int MAXbombcount = 180;
		static int bombcount = MAXbombcount;
		static int flagcount = 99;
		static double SIZE = GameMineSweeperStart.width / dimensionX;
