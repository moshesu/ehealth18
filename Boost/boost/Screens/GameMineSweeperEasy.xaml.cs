...
namespace boost.Screens
{
	...
	/// </summary>
	public sealed partial class GameMineSweeperEasy : Page
	{
		...
		static int dimensionX = 9;
		static int dimensionY = 9;

		static int parameterX = 168;
		static int parameterY = 64;

		static int MAXbombcount = 10;
		static int bombcount = MAXbombcount;
		static int MAXflagcount = 81;
		static int flagcount = MAXflagcount;
