...
{
	public sealed partial class CoachAddNewPlayerWeeklyGoals : Page
	{
		...
		private async void button_Click(object sender, RoutedEventArgs e)
		{
			...
			CoachAddNewPlayer.stepsAmount,
			CoachAddNewPlayer.stepsReward,
			CoachAddNewPlayer.sleepAmount,
			CoachAddNewPlayer.sleepReward,
			CoachAddNewPlayer.caloriesAmount,
			CoachAddNewPlayer.caloriesReward);
