...
namespace boost.Screens
{
    ...
    /// </summary>
    public sealed partial class PlayerViewWeeklyGoals : Page
    {
		...
		private void InitAllProgressBars(Grid outerGrid, DateTime date, int index)
		{
			...
			int i = 0;
			WeeklyProgressSummary sum = _IProgressFetcher.GetWeekly(DateTime.Today);
			...
			{
				ShowProgressBar(grid, "Caloriers Burned:", sum.CaloriesBurned, goals.WeeklyCaloriesBurned, (index != 0) ? 0 : goals.CaloriesBurnedReward, i);
				i++;
			}
